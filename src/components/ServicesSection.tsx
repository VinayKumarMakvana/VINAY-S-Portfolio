...
const SERVICES = [
  {
    ...
    description:
      'I specialize in architecting robust, end-to-end web applications. From intuitive front-end interfaces built with React and Tailwind to scalable back-end systems driven by Python, Java and Node.js — I handle the entire development lifecycle to deliver seamless, production-ready solutions.',
  },
  {
    number: '02',
    title: 'UI/UX Design',
