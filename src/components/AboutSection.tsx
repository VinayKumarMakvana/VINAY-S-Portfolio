...
const ABOUT_TEXT =
  "I'm a BCA Student at MCU,Bhopal. I focus on UI/UX, Full-Stack Development, and Generative AI — turning rough ideas into clean, engaging digital experiences. Let's build something incredible together!";
                      ...
                      <div className="flex flex-col gap-5 sm:gap-6">
                        {[
                          ...
                          },
                          {
                            ...
                            items: ['React', 'Tailwind', 'Spring Boot','Express.js', 'Django', 'FastAPI', 'Node.js'],
                          },
                          {
                            label: 'Tools & Platforms',
                            items: [ 'Colab', 'Jupyter Notebook', 'VS Code', 'Postman', 'Antigravity' ,'Docker','Vercel', 'Git', 'GitHub', 'Power BI', 'Canva', 'Google Sheets','Google Docs'],
                          },
                          {
                            label: 'AI & GenAI',
                            items: ['Gemini', 'Claude', 'OpenAI', 'Prompt engineering', "LLMs", "Agentic AI"],
                          },
                        ].map((group) => (
                          <div
                            key={group.label}
