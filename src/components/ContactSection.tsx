...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'vkmakvana.dev@gmail.com',
    href: 'mailto:vkmakvana.dev@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 76888 43283',
    // wa.me requires digits only — no +, no spaces, no hyphens
    href: 'https://wa.me/917688843283',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'vinay-kumar-makvana-2371ba391',
    href: 'https://www.linkedin.com/in/vinay-kumar-makvana-2371ba391/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@VinayKumarMakvana',
      ...
      <FadeIn delay={0.4} y={20}>
        <div className="mx-auto mt-20 sm:mt-24 md:mt-28 flex max-w-5xl flex-col items-center gap-3 border-t border-[#D7E2EA]/10 pt-8 text-center sm:flex-row sm:justify-between">
          ...
          <span
            ...
            style={{ fontSize: 'clamp(0.7rem, 1.1vw, 0.9rem)' }}
          >
            Designed & built with the help of Harsh Goyal and AI
          </span>
        </div>
      </FadeIn>
    </section>
